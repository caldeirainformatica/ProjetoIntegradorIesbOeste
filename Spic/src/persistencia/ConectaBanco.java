...
public class ConectaBanco {
	...
	private String caminho = "jdbc:mysql://localhost:3306/spic"; // responsavel por setar o endereço do bd
	...
	public void conexao(){//metodo responsável por realizar a conexão com o bd
		...
		//	JOptionPane.showMessageDialog(null, "conectado com sucesso"); // imprime uma cx de mensagem
	...
	public void desconecta(){ // metodo para fechar a conexão com o bd
		try {
			...
			JOptionPane.showMessageDialog(null, "desconectado com sucesso"); // imprime uma cx de mensagem
