...
public class DAO {
	...
	public void select(Produtos p) {
		try {
			...
			conecta.conexao();
			PreparedStatement pst = conecta.conn
					.prepareStatement("select * from produtos where idProdutos like ? or codigoBarras like ? or descricao like ? or "
							+ "aplicacao like ? or medida like ? or valorVenda like ? or valorCusto like ? or quantidade like ?");
