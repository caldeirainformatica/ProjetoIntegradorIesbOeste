	...
	private void initComponents() {
		...
		//	private Connection connection;
			...
			public void actionPerformed(ActionEvent e) {
				...
				this.rs = dao.rs;
				this.rs.first();
					txtAplicacao.setText(this.rs.getString("aplicacao"));
					txtCodigoBarras.setText(String.valueOf(this.rs.getLong("codigoBarras")));
					txtMedida.setText(this.rs.getString("medida"));
					txtDescricao.setText(this.rs.getString("descricao"));
					txtFabricacao.setText(String.valueOf(this.rs.getDate("dataFabricacao")));
					txtValidade.setText(String.valueOf(this.rs.getDate("dataValidade")));
					txtLote.setText(String.valueOf(this.rs.getInt("lote")));
								
					
				} catch (SQLException e1) {
					JOptionPane.showMessageDialog(null, "Erro ao puxar dados");
					e1.printStackTrace();
				}
		...
		layout.setVerticalGroup(layout.createParallelGroup(
				javax.swing.GroupLayout.Alignment.LEADING).addComponent(
				jTabbedPane1, javax.swing.GroupLayout.PREFERRED_SIZE, 448,
				javax.swing.GroupLayout.PREFERRED_SIZE));
